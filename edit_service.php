          ...
          <div class="col-lg-10 m-auto" style="background: linear-gradient(88deg, #13b4ca, #18cabe);">
              ...
              <form action="edit_service_post.php" method="post" enctype="multipart/form-data">
                  <div class="form-group my-4">
                    ...
                    <input type="text" class="form-control" name="service-title" placeholder="Enter about title" value="<?php echo $after_assoc['service_title']; ?>">
                  </div>
                  <div class="form-group my-4">
                    <textarea name="service-desp" rows="5" class="form-control" value=""><?php echo $after_assoc['service_desp'];?> </textarea>
                  </div>
                  <div class="form-group my-4">
                  ...
                  <div class="form-group my-4">
                    <p>prasent photo</p>
                    <img src="uploads/services/<?php echo $after_assoc['service_img'];?>" alt="" width="200px">
                  </div>
