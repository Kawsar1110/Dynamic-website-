                ...
                unset($_SESSION['exist']);
                 ...
                 <form action="service_post.php" method="post" enctype="multipart/form-data">
                   <div class="form-group my-4">
                     <input type="text" class="form-control" name="service-title" placeholder="Enter Service Title">
                   </div>
                   <div class="form-group my-4">
                     <textarea name="service-desp" rows="5" class="form-control"  placeholder="Enter Service description"></textarea>
                   </div>
                    <div class="form-group my-4">
                     ...
                     <div class="form-group my-4">
                         <input type="file" name="service-img" class="form-control" >
                     </div>
                   </div>
